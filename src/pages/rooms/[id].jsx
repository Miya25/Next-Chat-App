        ...
        <div className="col-span-9 w-full">
          <div className="border-b border-zinc-500/5 flex items-center justify-between px-6 py-5 text-white">
            ...
            <div className="flex items-center">
              <button
                onClick={LeaveRoom}
                className="bg-zinc-500/10 hover:bg-zinc-500/20 rounded-full p-2 mr-2"
              >
                <svg
            ...
            >
              <div className="flex items-center">
                <input
                  name="message"
                  type="text"
                  className="bg-zinc-500/10 rounded-md w-full px-4 py-2 text-white outline-none"
                  autoComplete="off"
                  placeholder="Type a message..."
                />
                <button
                  type="submit"
                  className="bg-zinc-500/10 hover:bg-zinc-500/20 rounded-md p-2 ml-2 transition-all duration-200"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    {room?.owner?.username === member?.username && (
                      <>
                        <div className="flex items-center justify-center gap-1">
                          <p className="text-sm font-medium uppercase font-semibold opacity-50">
                            Owner
                          </p>
                        </div>
                      </>
